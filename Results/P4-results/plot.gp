...
# plot logFile.".train" using 2:3 title "cifar100"

# Learning rate vs. training iterations;
# plot logFile.".train" using 1:4 title "cifar100"

# Learning rate vs. training time;
# plot logFile.".train" using 2:4 title "cifar100"
...
# plot "cifar100.log.test" using 1:3 title "cifar100"

# Test loss vs. training time
# plot "cifar100.log.test" using 2:4 title "cifar100"

# Test accuracy vs. training time
# plot "cifar100.log.test" using 2:3 title "cifar100"
